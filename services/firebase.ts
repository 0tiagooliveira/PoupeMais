...
// Firebase Storage SDK expects bucket id format: <project-id>.appspot.com
const normalizeStorageBucket = (rawBucket?: string) => {
  if (!rawBucket) return 'poupe-mais-6a07f.appspot.com';
  return rawBucket.replace('.firebasestorage.app', '.appspot.com');
};
...
const firebaseConfig = {
  ...
  storageBucket: normalizeStorageBucket(env.VITE_FIREBASE_STORAGE_BUCKET),
